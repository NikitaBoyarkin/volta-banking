...
> **12 projects** | Funnel → A/B → Retention → Segmentation → Churn → RFM → CLV → Attribution → Anomaly → Spend → Support & Churn → NPS | Fintech / Digital Banking
...
Product requirements and the as-is snapshot for this portfolio: [`docs/prd.md`](docs/prd.md) — 16 requirements (12 analytical domains + engineering/platform), metrics, and conservative maintenance roadmap. Vault note: `Obsidian/Z-core/PRD - Volta Banking.md`.
