...
> **16 projects** | Funnel → A/B → Retention → Segmentation → Churn → RFM → CLV → Attribution → Anomaly → Spend → Support & Churn → NPS → JTBD×Cohorts → Unit Economics → Premium Upsell → 45+ KYC Deep-Dive | Fintech / Digital Banking
