...
> **20 projects** | Funnel → A/B → Retention → Segmentation → Churn → RFM → CLV → Attribution → Anomaly → Spend → Support & Churn → NPS → JTBD×Cohorts → Unit Economics → Premium Upsell → 45+ KYC Deep-Dive → Referral Segments → Assisted CAC vs LTV → FX Sourcing → Segment Premium Offers | Fintech / Digital Banking

Twenty projects follow one product from first install to retention: an
