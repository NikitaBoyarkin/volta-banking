...
def generate_rfm_excel(
    ...
    data_dict = {
        ...
        'Customer_RFM': rfm_data[['customer_id', 'R_Quartile', 'F_Quartile', 'M_Quartile', 'Segment']]
    }
...
def generate_ab_test_excel(
    test_results: dict,
    output_path: str = "output/ab_test_results.xlsx"
) -> str:
    """
...
def generate_pdf_summary(
    ...
    output_path: str = "output/analysis_summary.pdf"
) -> str:
    """
...
if __name__ == "__main__":
    ...
    sample_data = {
        'Metrics': pd.DataFrame({
            'Metric': ['Users', 'Revenue', 'Conversion'],
            'Value': [10000, 500000, 0.15]
        }),
